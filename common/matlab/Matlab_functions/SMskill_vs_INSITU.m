...
INSITU_tag = 'CalVal_M33';  %'USCRN', 'Oznet', 'Msnet' , 'SMOSM'

add_anomR = 1;  % no need to compute anom R

fout_path = '/discover/nobackup/qliu/matlab/SMAP/';
...
fout_name = [fout_path,'/NRv11_M36_',INSITU_tag, '_SM_3h_',rzmc_tag,'_6yr_'];
...
if exist([fout_name,'raw_timeseries.mat'],'file')
    ...
    exp_path = { ...
        '/discover/nobackup/qliu/merra_land/SMAP_runs/SMAP_Nature_v11/';...
        '/discover/nobackup/qliu/merra_land/SMAP_runs/SMAP_Nature_v11/'...
        };
