...
L4_path = '/discover/nobackup/amfox/Experiments/DAv7_M36_SMAP_type_13_comb_fp_scaled/';
L4_run = 'DAv7_M36_SMAP_type_13_comb_fp_scaled'; 
L4_version = 'DAv7_M36_SMAP_type_13_comb_fp_scaled'; 

out_collection = '.SMAP_L4_SM_gph.';
domain = 'SMAP_EASEv2_M36_GLOBAL';

if contains(domain,'M09')
    out_path = '/discover/nobackup/qliu/matlab/SMAP/ASCAT/H119/';
else
...
while 1
    ...
    date_string = [num2str(date_time.year,'%4.4d'), ...
        ...
        f_out = [out_path,'L4_ASCAT_H119_SMSF_L4_',L4_version,'_QC_1_',date_string,'.mat'];
