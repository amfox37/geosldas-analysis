...
data_path = '/discover/nobackup/amfox/IVs_output/';

mod_version = 'OLv7_M36_MULTI_type_13_comb_fp_scaled';
...
f_clim= [data_path,'L4_ASCAT_',mod_version,'_clim_pentad_',time_tag,'_w31.mat'];
...
while 1
    ...
    % fname = [data_path,'SMPL3_R18_SMSF_MOD_',mod_version,'_QC_1_',date_string,'.mat']
    % fname_pre = [data_path,'SMPL3_R18_SMSF_MOD_',mod_version,'_QC_1_',date_string_pre,'.mat']
    fname = [data_path,'L4_ASCAT_H119_SMSF_L4_',mod_version,'_QC_1_',date_string,'.mat']
    fname_pre = [data_path,'L4_ASCAT_H119_SMSF_L4_',mod_version,'_QC_1_',date_string_pre,'.mat']  
...
% fname_out = [data_path,'SMPL3_',mod_version,'_IVD_IVS_stats_lag',num2str(Nlag),'day_',time_tag,'.mat'];
fname_out = [data_path,'L4_ASCAT_',mod_version,'_IVD_IVS_stats_lag',num2str(Nlag),'day_',time_tag,'.mat'];
