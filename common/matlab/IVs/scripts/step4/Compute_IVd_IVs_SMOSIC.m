...
while 1
    ...
    fname = [data_path,'SMOSIC_SMSF_MOD_',mod_version,'_QC_1_',date_string,'.mat'];
    fname_pre = [data_path,'SMOSIC_SMSF_MOD_',mod_version,'_QC_1_',date_string_pre,'.mat'];
...
fname_out = [data_path,'SMOSIC_',mod_version,'_IVD_IVS_stats_lag',num2str(Nlag),'day_',time_tag,'.mat'];
