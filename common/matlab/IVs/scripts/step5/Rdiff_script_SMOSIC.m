...
f_D1 =  [data_path,'SMOSIC_',D1_version,'_IVD_IVS_stats_lag2day_201808_202405.mat'];
f_D2 =  [data_path,'SMOSIC_',D2_version,'_IVD_IVS_stats_lag2day_201808_202405.mat'];
...
Rdiff_D2minusD1 = reshape(R_D2 - R_D1, 964, 406); %#ok<NASGU>
...
outname = ['Rdiff_',D2_version,'_minus_',D1_version,'_SMOSIC.mat'];
