...
obs_path = '/discover/nobackup/projects/land_da/Evaluation/IVs/data/SPL3SMP_v009/';

%mod_path = '/discover/nobackup/amfox/Experiments/DAv7_M36_ASCAT_type_2/';
%mod_run = 'DAv7_M36_ASCAT_type_2';
%mod_version = 'DAv7ASCt2_M36';

mod_path = '/discover/nobackup/projects/land_da/CYGNSS_Experiments/DAv8_M36_cd/';
mod_run = 'DAv8_M36_cd';
...
while 1
    ...
    flist = dir([obs_path, '/Y',num2str(date_time.year,'%4.4d'), ...
        '/SMAP_L3_SM_P_',date_string,'_R19240_*.h5']);
    ...
    f_out = [out_path,'SMPL3_R19_SMSF_MOD_',mod_version,'_QC_1_',date_string,'.mat'];
