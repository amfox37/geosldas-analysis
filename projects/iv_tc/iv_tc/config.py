...
class ProductRoots:
    ...
    ascat_cdr_root: Path = Path("/discover/nobackup/projects/land_da/ASCAT_SSM_CDR")
    legacy_ascat_root: Path = Path("/discover/nobackup/qliu/merra_land/DATA/ASCAT_HSAF")
