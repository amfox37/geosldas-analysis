...
exp_path = ['/discover/nobackup/projects/land_da/CYGNSS_Experiments/',exp_run_name{kkk},'/'];

% tmp mat file to store the time series
fout_name = [fout_path,'/',exp_run_name{kkk},'_',INSITU_tag, '_SM_1d_',rzmc_tag,'_6yr_']
