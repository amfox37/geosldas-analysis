"""
Close the DA water budget over WY2001-WY2006 (Oct 2000 - Sep 2006), single
experiment, no OL differencing. Mirrors close_ol_water_budget.py exactly,
substituting DA source files, to compare DA's own closure quality against OL's.
...
(DAv8_twland_wy_endpoints_2000_2006.nc, from LS_DAv8_M36_v2 restarts), and
cum(PEATCLSM_FSWCHANGE) is the 6-year cumulative peat free-standing-water flux
...
DA_CAT_ENS_AVG = "/discover/nobackup/projects/land_da/M21C_land_sweeper/LS_DAv8_M36_v2/LS_DAv8_M36/output/SMAP_EASEv2_M36_GLOBAL/cat/ens_avg"
TWLAND_ENDPOINTS = "/gpfsm/dnb06/projects/p284/geosldas-analysis/projects/M21C_ls/output/monthly_flux_states/DAv8_twland_wy_endpoints_2000_2006.nc"
PEAT_FSW = "/gpfsm/dnb06/projects/p284/geosldas-analysis/projects/M21C_ls/output/monthly_flux_states/DAv8_peat_fsw_2000_2024_compressed.nc"
WATER_BUDGET_REF = "/gpfsm/dnb06/projects/p284/geosldas-analysis/projects/M21C_ls/output/monthly_flux_states/DAv8_water_budget_2000_2024_compressed.nc"
...
def main():
    ...
    for (y, m) in months:
        path = os.path.join(DA_CAT_ENS_AVG, f"Y{y}", f"M{m:02d}",
                             f"LS_DAv8_M36.tavg24_1d_lnd_Nt.monthly.{y}{m:02d}.nc4")
    ...
    residual_A = cum_P - cum_ET - cum_Runoff - dStorage_approx
    residual_B = cum_P - cum_ET - cum_Runoff - dStorage_true
    residual_C = cum_P - cum_ET - cum_Runoff - dStorage_true - cum_FSW

    print("\n=== DA water budget closure, WY2001-WY2006 (6-year cumulative, kg m-2), area-weighted, all 112,573 tiles ===")
    ...
    print(f"\ngap (cum WCHANGE - true dStorage), area-weighted : {area_mean(gap):10.3f} kg m-2")
