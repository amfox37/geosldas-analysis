...
# Builds monthly cumulative sums from raw/submonthly catch_progn_incr files.
...
OUTPUT_FILE="${OUTPUT_FILE:-${OUTPUT_DIR}/catch_progn_raw_monthly_cumulative_200006_202405.nc}"

SCRIPT="${REPO}/projects/M21C_ls/scripts/build_raw_catch_progn_increment_summaries.py"
...
echo "Wrote raw catch_progn_incr cumulative summaries to ${OUTPUT_FILE}"
