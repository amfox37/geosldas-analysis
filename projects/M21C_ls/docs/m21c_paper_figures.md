...
Standardized monthly soil-water DA diagnostics across P1-P9 and native-unit
P5-P6 interrupted-series level changes with fitted-AR(1) bootstrap intervals.

![Figure 17: observing-system transitions](paper_figures/fig17_observing_system_transitions.png)
...
Accepted independent changepoints relative to known P2-P9 observing-system
boundaries, with P7 marked as detection-exempt.

![Supplemental Figure S8: breakpoint agreement](paper_figures/figS08_breakpoint_boundary_agreement.png)
