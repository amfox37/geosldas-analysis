...
Area-weighted, tile-seasonally-adjusted RZMC DA-OL for global valid land and
five fixed regions, in native units, with the mean within each P1-P9
observing-system period. The tile adjustment is the same as for Figure 16.
