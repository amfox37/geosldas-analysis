...
py_base = f"{OUT}/PYTHON_TEST_M21C_SMAP_Tb_ASC_2016_p1_2016_p18_hscale_0.00_W_15p_Nmin_20_A_"
ml_base = f"{OUT}/MATLAB_TEST_SMAP_Tb_ASC_2016_p1_2016_p18_hscale_0.00_W_15p_Nmin_20_A_"
...
for p in pentads:
    ...
    print(f"Python asc_flag={py.asc_flag}  MATLAB asc_flag={ml.asc_flag} (expect 1, ascending)")
